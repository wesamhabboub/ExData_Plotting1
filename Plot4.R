...
plot(power_ds$DateTime,power_ds$Global_active_power,xlab="",type="l", ylab="Global Active Power ")

plot(power_ds$DateTime,power_ds$Voltage,xlab="",type="l", ylab="Voltage")
...
plot(power_ds$DateTime,power_ds$Global_reactive_power,xlab="",type="l", ylab="Global Reactive Power ")
dev.off()